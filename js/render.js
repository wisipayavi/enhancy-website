...
const SVG_ACQUIRE = `<svg viewBox="0 0 420 240" fill="none" xmlns="http://www.w3.org/2000/svg"><rect x="92" y="60" width="124" height="152" rx="12" fill="#fff" stroke="#e6ebf3"/><rect x="112" y="78" width="84" height="84" rx="8" fill="#fff" stroke="#e6ebf3"/><g fill="#0b1b34"><rect x="124" y="90" width="20" height="20" rx="3"/><rect x="166" y="90" width="20" height="20" rx="3"/><rect x="124" y="132" width="20" height="20" rx="3"/><rect x="156" y="96" width="7" height="7"/><rect x="170" y="120" width="7" height="7"/><rect x="180" y="134" width="7" height="7"/></g><g fill="#fff"><rect x="129" y="95" width="10" height="10"/><rect x="171" y="95" width="10" height="10"/><rect x="129" y="137" width="10" height="10"/></g><g fill="#1d4ed8"><rect x="132" y="98" width="4" height="4"/><rect x="174" y="98" width="4" height="4"/><rect x="132" y="140" width="4" height="4"/></g><rect x="116" y="174" width="76" height="22" rx="6" fill="#eef3fb"/><text x="154" y="189" text-anchor="middle" font-size="11" font-weight="700" fill="#1d4ed8" font-family="Inter,sans-serif">Merchant QR</text><circle cx="300" cy="116" r="34" fill="#eafaf0" stroke="#22c55e" stroke-width="3"/><path d="M284 116l11 11 22-25" stroke="#22c55e" stroke-width="6" fill="none" stroke-linecap="round" stroke-linejoin="round"/><text x="300" y="182" text-anchor="middle" font-size="13" font-weight="700" fill="#5b6478" font-family="Inter,sans-serif">Payment accepted</text></svg>`;
const SVG_ISSUE = `<svg viewBox="0 0 420 240" fill="none" xmlns="http://www.w3.org/2000/svg"><g transform="translate(58,78)"><path d="M5 40 L55 14 L105 40" fill="none" stroke="#1d4ed8" stroke-width="3" stroke-linejoin="round"/><g stroke="#1d4ed8" stroke-width="3"><path d="M16 44v44M40 44v44M64 44v44M88 44v44"/></g><path d="M2 92h106" stroke="#1d4ed8" stroke-width="3" stroke-linecap="round"/></g><path d="M176 118h54" stroke="#1d4ed8" stroke-width="3" stroke-dasharray="6 6"/><path d="M226 111l12 7-12 7z" fill="#1d4ed8"/><rect x="250" y="50" width="104" height="156" rx="16" fill="#fff" stroke="#e6ebf3"/><text x="302" y="90" text-anchor="middle" font-size="11" fill="#6b7790" font-family="Inter,sans-serif">Enter UPI PIN</text><g fill="#1d4ed8"><circle cx="277" cy="116" r="7"/><circle cx="295" cy="116" r="7"/><circle cx="313" cy="116" r="7"/><circle cx="331" cy="116" r="7"/></g><circle cx="302" cy="162" r="20" fill="#eafaf0" stroke="#22c55e" stroke-width="2"/><path d="M293 162l6 6 12-13" stroke="#22c55e" stroke-width="4" fill="none" stroke-linecap="round" stroke-linejoin="round"/><text x="210" y="226" text-anchor="middle" font-size="13" font-weight="700" fill="#5b6478" font-family="Inter,sans-serif">Issuer authorization</text></svg>`;
const SVG_TPAP = `<svg viewBox="0 0 420 240" fill="none" xmlns="http://www.w3.org/2000/svg"><rect x="62" y="38" width="106" height="172" rx="16" fill="#fff" stroke="#e6ebf3"/><rect x="78" y="56" width="74" height="40" rx="8" fill="#1d4ed8"/><text x="115" y="81" text-anchor="middle" font-size="11" font-weight="700" fill="#fff" font-family="Inter,sans-serif">Pay</text><g fill="#eef3fb"><rect x="78" y="106" width="34" height="34" rx="8"/><rect x="118" y="106" width="34" height="34" rx="8"/><rect x="78" y="148" width="34" height="34" rx="8"/><rect x="118" y="148" width="34" height="34" rx="8"/></g><rect x="208" y="62" width="152" height="120" rx="10" fill="#0a1733"/><g fill="#3a5da8"><rect x="224" y="96" width="100" height="7" rx="3"/><rect x="242" y="112" width="80" height="7" rx="3"/><rect x="242" y="128" width="64" height="7" rx="3"/><rect x="224" y="144" width="92" height="7" rx="3"/><rect x="224" y="160" width="70" height="7" rx="3"/></g><rect x="224" y="80" width="60" height="7" rx="3" fill="#0ea5e9"/><text x="284" y="204" text-anchor="middle" font-size="13" font-weight="700" fill="#5b6478" font-family="Inter,sans-serif">SDK · S2S integration</text></svg>`;
const SVG_AI = `<svg viewBox="0 0 420 250" fill="none" xmlns="http://www.w3.org/2000/svg"><rect x="48" y="40" width="190" height="170" rx="14" fill="#fff" stroke="#e6ebf3"/><rect x="48" y="40" width="190" height="30" rx="14" fill="#eef3fb"/><circle cx="68" cy="55" r="6" fill="#1d4ed8"/><rect x="82" y="51" width="84" height="8" rx="4" fill="#cdd9f0"/><rect x="66" y="86" width="120" height="34" rx="10" fill="#eef3fb"/><g fill="#9fb3d6"><rect x="78" y="98" width="80" height="6" rx="3"/><rect x="78" y="108" width="54" height="6" rx="3"/></g><rect x="96" y="132" width="124" height="40" rx="10" fill="#1d4ed8"/><g fill="#bcd2ff"><rect x="110" y="145" width="84" height="6" rx="3"/><rect x="110" y="157" width="62" height="6" rx="3"/></g><g fill="#22c55e"><circle cx="80" cy="190" r="4"/><circle cx="94" cy="190" r="4"/><circle cx="108" cy="190" r="4"/></g><path d="M238 118h40" stroke="#1d4ed8" stroke-width="3" stroke-dasharray="6 6"/><path d="M274 111l12 7-12 7z" fill="#1d4ed8"/><circle cx="332" cy="98" r="40" fill="#eafaf0" stroke="#22c55e" stroke-width="2"/><path d="M332 74l6 18 18 6-18 6-6 18-6-18-18-6 18-6z" fill="#22c55e"/><text x="332" y="160" text-anchor="middle" font-size="11" font-weight="700" fill="#1d4ed8" font-family="Inter,sans-serif">AI Agent</text><g stroke="#0ea5e9" stroke-width="4" stroke-linecap="round"><path d="M286 198v8"/><path d="M300 192v20"/><path d="M314 186v32"/><path d="M328 194v16"/><path d="M342 188v28"/><path d="M356 198v8"/><path d="M370 193v18"/></g><text x="143" y="234" text-anchor="middle" font-size="13" font-weight="700" fill="#5b6478" font-family="Inter,sans-serif">Chat · Voice · Agents</text></svg>`;

const VISUALS = {
  "upi-stack": () => viz("UPI payment flow", SVG_UPI),
  "acquiring-upi-stack": () => viz("Merchant UPI acceptance", SVG_ACQUIRE),
  "issuing-upi-stack": () => viz("Issuer authorization", SVG_ISSUE),
  "tpap-stack": () => viz("TPAP SDK / S2S", SVG_TPAP),
  ...
  "enhency-ai": () => viz("AI assistants & automation", SVG_AI),
...
function renderPage(p, id) {
  ...
  if (p.sections && p.sections.length) {
    ...
    const off = id ? id.split("").reduce((a, c) => a + c.charCodeAt(0), 0) % builders.length : 0;
    html += `<section class="section"><div class="container">`;
    p.sections.forEach((s, i) => {
      const labels = s.caps ? s.caps.map((c) => c.t) : [];
      const seed = (id ? id.length : 0) + i * 3 + s.title.length;
      const vis = builders[(i + off) % builders.length](s.title, labels, seed);
...
function renderContact() {
  ...
  <section class="section soft" id="contact-form"><div class="container">
    <div class="grid cols-2" style="align-items:start">
      ...
      <form class="form-card reveal" id="contactForm" action="https://formsubmit.co/support@enhency.com" method="POST" novalidate>
